...
```{r load_data, echo=F}
dv_data <- read_csv(file = 'data/num_dvs_data.csv')
```
...
sim_data <- run_exp_simulations(sim_params = sim_params, num_iterations = 2, 
                                num_cores = detectCores() - 1, seed = 27, step_size = F)
...
sim_data <- run_exp_simulations(sim_params = sim_params, num_iterations = 5e3, num_cores = 3, seed = 27, step_size = F)
```
