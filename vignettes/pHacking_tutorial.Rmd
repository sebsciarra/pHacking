...
packages <- c('tidyverse', 'MASS', 'devtools', 'parallel')
libraries(packages)
load_all()
```
...
run_mult_simulations(num_iterations, param_list, seed = 27, num_cores = 3)

#familywise error rate  = 1 – (1-alpha)^n
